  ...
  <div class="card">
    <div class="card-header pb-0 px-4">
      <div class="d-flex flex-row justify-content-between">
        <div>
          <h5 class="mb-0">Thiết lập email thông báo cho người phỏng vấn</h5>
        </div>
      </div>
    </div>
    <div class="card-body p-4">
      <form action="" method="POST" role="form">
        ...
        <div>
          <p class="text-sm pl-2 font-semibold italic mb-1 text-yellow-400">Lưu ý: Giữ nguyên định dạng các nhãn [...] khi chỉnh sửa email</p>
        </div>
