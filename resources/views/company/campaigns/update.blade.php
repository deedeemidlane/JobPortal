      ...
      <div class="card mb-4 mx-4 p-4 pb-0 pt-2">
        ...
        <div class="card-body pt-4">
          <form action="/company/campaigns/create" method="POST" role="form text-left">
            ...
            <a href="/company/campaigns/{{$campaign->id}}/recruitment-news" class="w-fit bg-blue-500 text-white font-bold btn-sm mb-3 d-flex align-items-center gap-2 px-3 py-2 hover:opacity-90">
