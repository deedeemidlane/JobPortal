    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div>
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse m-0 ps-3">
                    <li class="inline-flex items-center">
                        <a href="#" class="inline-flex items-center text-sm font-bold text-gray-500 hover:text-gray-700">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-bold text-green-500 md:ms-2">{{$tab_name}}</span>
                        </div>
                    </li>
                </ol>
            </nav>
